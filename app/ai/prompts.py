...
class PromptManager:
    ...
    _SYSTEM_PROMPT = "You are Jarvis, a helpful desktop AI assistant."
    _DEVELOPER_PROMPT = "Provide clear, well-structured, and compliant code outputs."
    _TOOL_PROMPT = "Utilize available tools when requested to retrieve accurate data."
    _SAFETY_PROMPT = "Ensure all user inputs are handled safely and respect user privacy."
    _TOOL_USE_POLICY = (
